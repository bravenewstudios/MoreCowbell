...
public class ActorBeta extends Actor {
    ...
    public void autoScaleByHeight() {
        float scale = Gdx.graphics.getHeight() / 1920;
        setSize(getWidth()*scale,getHeight()*scale);
        setOrigin(Align.center);
    }

    public void autoScaleByWidth() {
        float scale = Gdx.graphics.getWidth() / 1080;
        setSize(getWidth()*scale,getHeight()*scale);
        setOrigin(Align.center);
    }

    public void scaleToScreenHeight(float scale)
    {
        float pctOfHeight = getHeight() / (float)Gdx.graphics.getHeight();
        scale = scale / pctOfHeight;
        setSize(getWidth()*scale,getHeight()*scale);
        setOrigin(Align.center);
    }

    public void scaleToScreenWidth(float scale)
    {
        float pctOfWidth = getWidth() / (float)Gdx.graphics.getWidth();
        scale = scale / pctOfWidth;
        setSize(getWidth()*scale,getHeight()*scale);
        setOrigin(Align.center);
    }
     ...
     * @param height
     */
    public Vector2 preventOverlap(ActorBeta other,float x, float y) {
        ...
        this.moveBy(x*mtv.normal.x * mtv.depth, y*mtv.normal.y * mtv.depth);
